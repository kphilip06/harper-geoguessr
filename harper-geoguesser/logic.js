// 1. Modern Firebase Module Imports (at the absolute top of logic.js)
import { initializeApp, getApps } from "https://www.gstatic.com/firebasejs/10.8.0/firebase-app.js";
import { getFirestore, collection, addDoc, serverTimestamp } from "https://www.gstatic.com/firebasejs/10.8.0/firebase-firestore.js";
import { getAuth } from "https://www.gstatic.com/firebasejs/10.8.0/firebase-auth.js";

// 2. Double check these credentials against your Firebase Console!
...
// 3. This is what builds the link! Make sure these lines are exactly here:
...
function saveScore(username, totalScore) {
    ...
    // 2. Use the modern addDoc/collection syntax
    return addDoc(collection(db, "leaderboard"), {
        username: username,
        score: parseInt(totalScore),
        timestamp: serverTimestamp() // Uses the imported serverTimestamp function
    })
    .then((docRef) => {
